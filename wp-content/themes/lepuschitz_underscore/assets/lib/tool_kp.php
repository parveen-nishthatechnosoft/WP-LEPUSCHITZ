...
<section class="catalog-import-card" aria-labelledby="catalog-import-title">
    <div class="catalog-import-card__intro">
        <h2 id="catalog-import-title">KP-Plattner-Katalog importieren</h2>
        <p>Wählen Sie die aktuelle KP-Plattner-Produktdatei im XLSX-Format aus.</p>
    </div>
    <div class="catalog-import-fields">
        <div class="catalog-import-field">
            <label for="kp-file">Produktdatei</label>
            <input type="file" id="kp-file" accept=".xlsx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
        </div>
    </div>
...
<script>
    ...
    function UploadFile() {
        ...
        var lFileField = document.getElementById('kp-file');
        ...
        var lAjaxUrl = "/wp-content/themes/lepuschitz_underscore/assets/lib/ajax_catalog_kp.php?tool=uploadFile<?php echo($lDebug); ?>&id=<?php echo($lCatalogId); ?>";
    ...
    function ImportCatalog(aTempFileName) {
        // define the EventSource object and the
        // push notifications sending server side script
        var lAjaxUrl = "/wp-content/themes/lepuschitz_underscore/assets/lib/ajax_catalog_kp.php?tool=importCatalog<?php echo($lDebug); ?>&id=<?php echo($lCatalogId); ?>&tempFile=" + aTempFileName;
